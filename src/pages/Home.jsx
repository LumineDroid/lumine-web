...
const AnimatedIllustration = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div className="relative z-10" animate={floatingVariants.animate}>
            ...
            >
              ...
              <motion.p
                ...
                className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 
                                           leading-relaxed"
              >
                A clean, stable, and secure Android custom ROM built from AOSP.
                Minimal modifications, maximum stability. Open source,
        ...
        <section className="mb-16 sm:mb-24 lg:mb-28">
          ...
          >
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              LumineDroid is made possible thanks to the Android Open Source
              Project (AOSP), CodeLinaro, and contributions from the vibrant
              open-source Android development community. Special thanks to all
              maintainers and contributors who make this project a reality.
            </p>
          </motion.div>
        </section>
          ...
          >
            ...
            <motion.div className="relative z-10">
              ...
              <p className="text-pink-50 mb-8 sm:mb-10 lg:mb-12 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed">
                Contribute to LumineDroid, report issues, get support. Be part
                of something great!
              </p>
