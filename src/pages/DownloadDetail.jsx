            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-100/70 dark:bg-yellow-500/10 border border-yellow-200/50 dark:border-yellow-500/30 rounded-lg p-4">
                <p className="text-sm text-yellow-800 dark:text-yellow-300">
                  <span className="font-semibold">⚠️ Warning:</span> This ROM is
                  provided as-is without any warranty. Please make a full backup
                  before flashing.
                </p>
              </div>
            </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {device.currently_maintained !== undefined && (
                    <div>
                      ...
                      >
                        {device.currently_maintained ? "Yes" : "No"}
                      </span>
                    </div>
                  )}
                  ...
                  {device.size && (
                    <div>
                      ...
                      <span className="font-semibold text-slate-900 dark:text-white ml-2">
                        {(device.size / 1024 ** 3).toFixed(2)} GB
                      </span>
                    </div>
                  )}
                ...
                >
                  <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-lg p-6 border border-slate-200/50 dark:border-slate-700/50">
                    ...
                    {changelog.split("\n").length > MAX_LINES && (
                      ...
                      >
                        {showFullChangelog ? "Show Less" : "View All"}
                      </button>
                    )}
                  </div>
                </motion.div>
                  ...
                  <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-lg p-6 border border-slate-200/50 dark:border-slate-700/50">
                    ...
                    <ol className="space-y-3 text-slate-700 dark:text-slate-300">
                      <li className="flex gap-3">
                        ...
                        <span>Unlock the bootloader of your device.</span>
                      </li>
                      <li className="flex gap-3">
                        <span className="font-semibold text-pink-600 dark:text-pink-400 flex-shrink-0">
                          2.
                        </span>
                        <span>Install a custom recovery (e.g., TWRP).</span>
                      </li>
                      <li className="flex gap-3">
                        <span className="font-semibold text-pink-600 dark:text-pink-400 flex-shrink-0">
                          3.
                        ...
                        <span>
                          Boot into recovery and wipe data, cache, and dalvik /
                          format data.
                        </span>
                      </li>
                      <li className="flex gap-3">
                        ...
                        <span>Flash the LumineDroid ZIP file.</span>
                      </li>
                      <li className="flex gap-3">
                        <span className="font-semibold text-pink-600 dark:text-pink-400 flex-shrink-0">
                          5.
                        </span>
                        <span>Reboot your device and enjoy LumineDroid!</span>
                      </li>
                    </ol>
                  </div>
                </motion.div>
